...
public class CardHoverHandler : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
{
    ...
    private Quaternion originalRotation; // Store the original position for resetting
    ...
    public void OnBeginDrag(PointerEventData eventData)
    {
        ...
        originalRotation = rectTransform.rotation; // Save position
